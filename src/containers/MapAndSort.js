  ...
  mapSavesToHtml = (saves, storeSaves) => {
    const savesMappedToHtml = saves.map(save => {
      return {
        ...
        displaySubreddit_t: (
          <div className="subreddit_t">{save.subreddit}:</div>
        ),

        displaySubreddit_c: (
          <div className="subreddit_c">{save.subreddit}:</div>
        ),
        ...
        displayTitle: (
          <div className="title-grid-container">
            <div className="title-grid">
              <p className="thread">
                <a href={save.link} target="_blank" rel="noopener noreferrer">
                  {' '}
                  {save.title}{' '}
                </a>
              </p>
        ...
        displayBody: <pre className="comment">{save.body}</pre>,
