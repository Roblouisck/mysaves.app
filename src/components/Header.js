      ...
      <div className="grid-header-container">
        <div className="grid-header">
          <div className="btn-group">
            <button onClick={this.handleButtons} id="btn-all-saves">
              All Saves
            </button>
            <button onClick={this.handleButtons} id="btn-only-threads">
              Threads
            </button>
            <button onClick={this.handleButtons} id="btn-only-comments">
              Comments
            </button>
          </div>
          ...
          <form>
            ...
            />
            <i
              className="cancelSearch fas fa-times"
              onClick={this.handleIconClick}
              ref={this.cancelSearch}
            >
              {' '}
            </i>
